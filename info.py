...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '5481546790:AAER_xZlgL8DO1ZKyROfAowEAAgrKO722pQ')
if len(BOT_TOKEN) == 0:
...
SHORTLINK_API = environ.get("SHORTLINK_API", "cc266075ad29dc23f74e600b618457a17c7fa05b")
