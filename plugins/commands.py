...
async def start(client, message):
    ...
    if mc.startswith('verify'):
        ...
        if verify_status["link"] == "":
            ...
            reply_markup = InlineKeyboardMarkup(btn)
        await message.reply(
          f"✅ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟ\n"
          f"━━━━━━━━━━━━━━━━━━\n\n"
          f"🔓 ʙᴏᴛ ᴀᴄᴄᴇꜱꜱ ᴜɴʟᴏᴄᴋᴇᴅ\n"
          f"⏳ ᴠᴀʟɪᴅ ꜰᴏʀ: {get_readable_time(VERIFY_EXPIRE)}",
          reply_markup=reply_markup,
...
async def set_pm_search(client, message):
    ...
    if option in ['on', 'true']:
        ...
        await message.reply_text("<b>♻️️ ᴘᴍ ꜱᴇᴀʀᴄʜ ᴅɪꜱᴀʙʟᴇᴅ, ɴᴏ ᴏɴᴇ ᴜꜱᴇʀꜱ ᴀʙʟᴇ ᴛᴏ ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇ ɪɴ ʙᴏᴛ ᴘᴍ.</b>")
    else:
